...
function preload (){
  ...
  pacmanImage=loadAnimation("p1.png","p2.png","p3.png","p4.png","p5.png")
...
function draw() {
  ...
  if (keyDown(UP_ARROW)){
   ...
   if (dotGroups.isTouching(pacman)){

   }
    if (pacman.isTouching(g1) || pacman.isTouching(g2) || pacman.isTouching(g3)){
      pacman.x=400
      pacman.y=150
    }
}
